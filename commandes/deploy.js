...
✞Rahmani-md owner , *Japhet* ,will send you the code immediately.Copy the code and whatsapp will bring a notification 
✞Tap on the notification and paste the code that Rahmani-md owner sent you.
✞ After a successful login Japhet-md owner 🤔 Rahmani will send you a *session id* .some will wonder where the hell is that session ,,,...It is just right at your inbox /dm {your own number for whatsappp} 😂
✞Copy the Session id {the one with unreadable codes and long copy it and send it to your deployer or deploy
     𝐇𝐎𝐖 𝐓𝐎 𝐃𝐄𝐏𝐋𝐎𝐘 JAPHET-MD
✔ Now check on Rahmani-md repository in github fork and give a star to this repository before doing anything 🌟or else Japhet-md 67 owner won't allow you to deploy his bot🤖.
...
✔Now click on this devs number and give Japhet-md 67 owner credits https://wa.me/255788484546
╰────────────────────☆`;
let menuMsg = `
     𝐑𝐞𝐠𝐚𝐫𝐝𝐬 dev Japhet`;
   var lien = mybotpic();
